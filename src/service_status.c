...
NOTES:
	- Mar_23-21: load_kmod_driver() can be highly vulnerable, if an attacker is able to modify the origin file, an arbitrary module can be loaded on kernel space
